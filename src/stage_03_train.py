...
import pandas as pd
import os
from sklearn.linear_model import ElasticNet #importing the model
...
def train(config_path, params_path):
    ...
    train_y = train_data["quality"] #outpute of train data
    train_x = train_data.drop("quality", axis=1)#input for train data
