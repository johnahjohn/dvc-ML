...
def split_and_save(config_path, params_path):
    ...
    #we will be reading data from the raw_loacal_file_path where we saved that data
    ...
    # For saving these data we will create a function in the utils.py 
    split_data_dir = config["artifacts"]["split_data_dir"]

    create_directory([os.path.join(artifacts_dir, split_data_dir)])
    # taking the file names from the config.yaml file
